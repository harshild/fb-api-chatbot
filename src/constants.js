...
module.exports.APIAI_ACCESS_TOKEN  ;
module.exports.FB_PAGE_ACCESS_TOKEN  ;
module.exports.FB_VERIFY_TOKEN ;
module.exports.APIAI_LANG  ;
module.exports.REST_PORT ;
module.exports.DATABASE_ENABLE ;
module.exports.DATABASE_URL  ;
module.exports.TABLE_NAME ;

module.exports.refreshConfig = function () {
